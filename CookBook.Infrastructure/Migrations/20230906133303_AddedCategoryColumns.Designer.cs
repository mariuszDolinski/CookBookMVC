...
namespace CookBook.Infrastructure.Migrations
{
    ...
    [Migration("20230906133303_AddedCategoryColumns")]
    partial class AddedCategoryColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CookBook.Domain.Entities.RecipeCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 6, 15, 33, 3, 822, DateTimeKind.Local).AddTicks(6792));

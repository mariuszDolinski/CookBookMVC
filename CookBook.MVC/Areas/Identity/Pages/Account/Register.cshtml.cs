...
namespace CookBook.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(30, ErrorMessage = "Nazwa użytkownika powinna mieć minimum {2} oraz maksimum {1} znaków.", MinimumLength = 4)]
            ...
            [StringLength(1000, ErrorMessage = "Hasło powinno mieć minimum {2} znaków.", MinimumLength = 8)]
